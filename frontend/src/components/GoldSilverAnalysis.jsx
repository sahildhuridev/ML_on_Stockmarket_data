    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                setError(error.response?.data?.error || "Gold and silver analysis failed to load.");
    ...
    if (error) {
        return (
            <div className="bg-white text-gray-900 p-6 shadow rounded mb-8">
                <h2 className="text-xl font-bold mb-3">Gold and Silver Correlation Analysis (Multivariate)</h2>
