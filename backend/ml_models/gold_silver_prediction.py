...
def analyze_gold_silver_multivariate(interval='1y'):
    ...
    exp_gld = lime_explainer_gld.explain_instance(X[-1], lr_gld.predict, num_features=6)
    ...
    exp_slv = lime_explainer_slv.explain_instance(X[-1], lr_slv.predict, num_features=6)
